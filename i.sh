...
termuxInstallHaisV4(){
	...
	if [ ! $(which proot) ]; then 
		curl "https://hais.coding.net/p/HaisV4/d/file/git/raw/master/aarch64/proot" -O ${PREFIX}/bin/proot && chmod +x ${PREFIX}/bin/proot
	fi
	...
	curl "https://hais.coding.net/p/HaisV4/d/file/git/raw/master/all/rootfs.tar.xz" -o $HOME/${linux}.tar.xz
	...
	curl "https://hais.coding.net/p/HaisV4/d/file/git/raw/master/aarch64/curl" -o $HOME/${linux}/bin/curl && chmod +x $HOME/${linux}/bin/curl
	curl "https://hais.coding.net/p/HaisV4/d/aarch64/git/raw/master/HaisAuto.sh" -o $HOME/${linux}/bin/hais && chmod +x $HOME/${linux}/bin/hais
...
linuxInstallHaisV4(){
	...
	chmod +x /bin/hais
	wget -q -c --show-progress "https://hais.coding.net/p/HaisV4/d/${ARCH_NAME}/git/raw/master/HaisAuto.sh" -O ./Install.sh
	chmod +x ./Install.sh
	./Install.sh
	rm -rf ./Install.sh
	exit
...
linuxInstallCloudHaisV4(){
	...
	git clone --depth 1 https://e.coding.net/hais/HaisV4/${ARCH_NAME}_task.git $ToolsPath
